...
export default function FrenchTravel() {
  ...
  useEffect(() => {
    document.title = "Informations de Voyage | Preeti & Harpreet";
      ...
      <nav className="navbar navbar-expand-lg fixed-top">
        <div className="container">
          ...
          <div className="lang-switcher d-inline-flex d-lg-none ms-auto me-2">
            ...
            <Link to="/travel" className="lang-btn">EN</Link>
            <Link to="/fr/travel" className="lang-btn active">FR</Link>
          </div>
      ...
      <div className="container my-5">
        ...
        <div className="my-5">
          ...
          <div className="p-4 border rounded bg-white text-center">
            ...
            <div className="mt-4">
              <Link to="/fr/book-vijayran" className="btn btn-custom px-4 py-2">
                <i className="fa-solid fa-hotel"></i> Réserver la Chambre & Détails de Paiement
              </Link>
            </div>
          </div>
        </div>
